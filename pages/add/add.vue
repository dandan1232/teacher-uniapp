	...
	<view class="container0" >	
	 <!-- 文本框 分享的文字内容 -->
		<div class="input" coordinate="true" >
			<textarea  placeholder="快说说你的想法吧~~" class="input-text" />
		...
		<div class="footer" style=" :bottom: 'footerBottom px';">
				...
				<image src="../../static/publish/icon_gouxuan.png"  v-show="show"  @click="back" class="mt-2 ml-3"></image>
				<image src="../../static/publish/icon_gouxuan.png"  v-show="!show"  @click="changeImg" class="mt-2 ml-3"></image>
		  </div>
